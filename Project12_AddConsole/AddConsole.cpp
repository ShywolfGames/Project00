...
void AddConsole::initialize(HWND hw)
{
	Game::initialize(hw);
...
void AddConsole::collisions()
{

}

void AddConsole::render()
{
	if (spriteText)
	{
		//=============================================================================
...
void AddConsole::releaseAll()
{
	fontCK->onLostDevice();
	dxFont14->onLostDevice();
	dxFont24->onLostDevice();
	dxFont48->onLostDevice();
	dxFont48B->onLostDevice();
	dxFont96->onLostDevice();
	dxFont24F->onLostDevice();
	Game::releaseAll();
}

void AddConsole::resetAll()
{
	fontCK->onResetDevice();
	dxFont14->onResetDevice();
	dxFont24->onResetDevice();
	dxFont48->onResetDevice();
	dxFont48B->onResetDevice();
	dxFont96->onResetDevice();
	dxFont24F->onResetDevice();
	Game::resetAll();
	return;
}
